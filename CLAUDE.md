...
- **Option B build spec (Budgets · Reports · Dashboard · Balance Sheet):** see `docs/sure-reference/` — clean-room formulas reverse-engineered from Sure (`we-promise/sure`, AGPL-3.0) in wealth-os terms, **not Sure source**. Read `99_INDEX.md` + `00_PORTING_GUIDE.md` first.
