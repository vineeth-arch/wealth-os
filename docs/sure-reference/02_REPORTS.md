...
9. **Trends** (`build_trends_data:324`): month-by-month income / expense / net / savings-rate across the period.
10. **Net-worth & investment metrics** — see `04_BALANCE_SHEET.md` and the holdings/capital-gains modules; reports just assemble them per period.
